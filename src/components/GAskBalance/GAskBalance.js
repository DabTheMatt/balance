        ...
        {this.state.showHow ? (
          <div className="balanceCenterContainer whiteBackground">
            <div className="replayContainer whiteBackground">
              ...
              <div>{[...this.state.table].map((i, index) => {
                return <img key={index} className={this.state.objectName} src={ `${this.state.image}`+ `${(Math.floor(Math.random() * (this.state.numberOfImages ) + 1))}`+`.png`} />;
              })}</div>
          ...
          <div className="balanceCenterContainer tealBackground">
            <form onSubmit={this.handleSubmit} className="askForm ">
              ...
              <button
                ...
                style={{ textTransform: "" }}
              >
                check <span className={this.state.isEnterClassName}>>></span>
              </button>
            </form>
            <p className="balanceVersion">v0.3-alpha-grid</p>
          </div></div>
        )}
